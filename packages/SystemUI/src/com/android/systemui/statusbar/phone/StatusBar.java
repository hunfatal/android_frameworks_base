...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    private class NavigationBarObserver extends ContentObserver {
        ...
        public void update() {
            int showNavBar = Settings.System.getIntForUser(
                    ...
                    -1, mLockscreenUserManager.getCurrentUserId());
            if (showNavBar != -1){
    ...
    private boolean themeNeedsRefresh(){
        ...
        mContext.getSharedPreferences("systemui_theming", 0).edit().putString("build_fingerprint", Build.HAVOC_FINGERPRINT).commit();
        return true;
    }
